...
class LoadImagesAndLabels(Dataset):  # for training/testing
    def __init__(self, path, img_size=416, batch_size=16, augment=False, hyp=None, rect=False, image_weights=False,
        ...
        ############set batch_shapes with the aspect ratio while shuffling#########################
        else:
            s = self.shapes  # wh
            ar = s[:, 1] / s[:, 0]  # aspect ratio
            # Set training image shapes
        ...
        np_labels_path = str(Path(self.label_files[0]).parent) + '1.npy'  # saved labels in *.npy file
    ...
    def __getitem__(self, index):
        ...
        if self.mosaic:
            ...
            shape = self.batch_shapes[self.batch[index]] # final letterboxed shape
